 ...
 *)
  ...
  let arc_grand={max=3;current=0;visited=false;cost=0;sign=1};;
  let arc2={max=1;current=0;visited=false;cost=0;sign=1};;
  ...
  let gre_get_arc1_2={max=2;current=2;visited=false;cost=0;sign=1}
  let gre_get_arc2_3={max=2;current=2;visited=false;cost=0;sign=1}
